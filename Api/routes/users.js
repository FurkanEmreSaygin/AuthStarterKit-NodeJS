...
router.post('/update', async(req,res,next)=>{
    ...
    try {
        ...
        if(Array.isArray(body.roles)&&body.roles.length > 0){
            ...
            const currentRoleIds = currentDbUserRoles.map(doc => doc.role_id.toString());
            ...
            const userRoleToDelete = currentDbUserRoles.filter(doc => rolesToDelete.includes(doc.role_id.toString()));
